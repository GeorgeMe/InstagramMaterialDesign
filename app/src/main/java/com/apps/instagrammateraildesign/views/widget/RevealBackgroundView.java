...
/**
 * Created by Mohamed on 31/01/15.
 */
public class RevealBackgroundView extends View {
    ...
    private onChangeStateListner onChangeStateListner;
    ...
    public void startFromLocation(int[] tapLocationOnScreen) {
        ...
        revealAnimator = ObjectAnimator.ofInt(this, "currentRadius", getWidth() + getHeight()).setDuration(FILL_TIME);
    ...
    private void changeState(int state) {
        ...
        if (onChangeStateListner != null) {
            onChangeStateListner.onStateChange(state);
        }
    }
    ...
    public void setOnChangeStateListner(onChangeStateListner onChangeStateListner) {
        this.onChangeStateListner = onChangeStateListner;
    }
